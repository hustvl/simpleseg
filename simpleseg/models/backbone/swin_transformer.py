...
def build_swin_lite(cfg):

    model = SwinTransformer(
        embed_dim=cfg.MODEL.SWINLITE.EMBED_DIM,
        depths=cfg.MODEL.SWINLITE.DEPTH,
        num_heads=cfg.MODEL.SWINLITE.HEADS,
        window_size=cfg.MODEL.SWINLITE.WINDOW_SIZE,
        mlp_ratio=4,
        qkv_bias=True,
        drop_path_rate=0.3,
        ape=False,
        patch_norm=True,
        out_indices=cfg.MODEL.BACKBONE_OUTPUTS,
        use_checkpoint=False)
